...
<body style=" background-image: url(<?php echo base_url() ?>assets/img/bg-img/welcome-bg.png);
    height: 900px;
    position: relative;
    z-index: 1;
   ...
   <!--input -->           <?php echo form_open( base_url().'Welcome/kerusakan/');?>  
                                <div class="form-group">
                                    <div class="input-group">
                                        <!-- <div class="input-group-addon">Username</div> -->
                                        <input type="text" readonly id="username3" name="id" class="form-control " style="text-align:center; color:Black" placeholder="Nama " value="<?php echo $_SESSION['user'] ?>">
        ...
        <header id="header" class="header">  
            <div class="top-left">
                <div class="navbar-header"> 
                    <a class="navbar-brand" href="<?php echo base_url() ?>"><img style="width: 70px; height:45px" src="<?php echo base_url() ?>assets/img/logo_gowater.png" alt="Logo"></a>
                ...
                <div class="header-menu"> 
                  <div class="user-area dropdown float-right ">
                        ...
                        <div class="user-menu dropdown-menu">        
                            <a class="nav-link" href="#"><i class="fa fa-bell-o"></i>Agenda<span class="count"><?php echo $_SESSION['agenda'] ?></span></a>  
                            <a class="nav-link" href="<?php echo base_url()."welcome/keluar/" ?>"  ><i class="fa fa-power-off"></i>Keluar</a>
                        </div>
                    </div> 
                </div>  
            </div>
                            ...
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib"> 
                                        <div class="stat-text"><span class="count"><?php echo $_SESSION['pakai']?></span> m<sup>3</sup></div>         
                                        <div class="stat-heading">Pemakaian </div>
                                        <div style="position:absolute" class="stat-heading"><?php  echo $newDate = date("d-m-Y", strtotime($_SESSION['tanggal'])); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib">
                                        <div class="stat-text" ><h style="position:absolute;left:6rem;" >Rp</h><span style="margin:8px" class="count"><?php $b=$_SESSION['pakai']; echo $b*2000 ?></span></div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib"> 
                                        <div class="stat-text"><h style="position:absolute;left:6rem;" >Rp </h><span style="margin:8px" class="count"><?php echo $_SESSION['saldo'] ?></span></div>
                            ...
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib"> 
                                        ...
                                        <div class="stat-text"><span class="count"><?php echo $_SESSION['agenda'];?></span></div> 
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <tbody>  
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?php echo  date('d-m-Y ',strtotime($_SESSION['tgl']));?></td>
                                                                                    <td><?php echo $_SESSION['ket'];?></td>
                                                                                </tr>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
